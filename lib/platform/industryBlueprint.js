...
export const INDUSTRY_BLUEPRINTS = {
  'real-estate': {
    ...
    pages: [
      ...
      { slug: 'faq', title: 'FAQ', sections: ['faqFullPage'] },
    ],
    cmsCollections: [
  ...
  logistics: {
    ...
    pages: [
      { slug: 'home', title: 'Home', sections: ['heroLanding', 'platformHero', 'courierPartners', 'integrationBenefits', 'integrationSteps', 'integrationFeatures', 'aiCourierRecommendation', 'businessTypes'] },
