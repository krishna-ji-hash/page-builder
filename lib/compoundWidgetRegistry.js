...
export const COMPOUND_WIDGET_META = Object.freeze({
  ...
  stats_counter: {
    kind: COMPOUND_CHROME_KINDS.stats_counter,
    label: 'Stats Counter',
    caps: {
      supportsTypography: false,
      supportsBackground: false,
  ...
  tab_hero: {
    kind: COMPOUND_CHROME_KINDS.tab_hero,
    label: 'Tab Hero',
    caps: {
      supportsTypography: false,
      supportsBackground: false,
...
export const DATA_DRIVEN_COMPOUND_NODE_TYPES = new Set(['tabs', 'accordion', 'carousel', 'stats_counter', 'tab_hero']);
