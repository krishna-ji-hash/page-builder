/** Default FAQ accordion items — Shipmozo-style section template. */

export const DEFAULT_FAQ_ITEMS = [
  {
    id: 'faq-1',
    question: 'What is Shipmozo and how does it help eCommerce sellers?',
    answer:
      'Shipmozo is a courier aggregator that lets you ship with multiple carriers from one dashboard — compare rates, print labels, track shipments, and manage COD in one place for D2C and marketplace sellers.',
  },
  {
    id: 'faq-2',
    question: 'How is Shipmozo different from other shipping aggregators in India?',
    answer:
  ...
  {
    id: 'faq-3',
    question: 'Is Shipmozo free to use? Are there any hidden charges?',
    answer:
  ...
  {
    id: 'faq-4',
    question: 'How do I start shipping with Shipmozo? What documents are needed?',
    answer:
