...
import { BLOG_SECTION_NODE_TYPES } from './blogSectionRegistry.js';
...
const OVERRIDES_BASE = {
  ...
  faq_full_page: { supportsCms: true },
  blog_full_page: { supportsCms: true },
  blog_detail_page: { supportsCms: true },
  blog_detail_hero: { supportsCms: true },
  blog_detail_article: { supportsCms: true },
  blog_detail_sidebar: { supportsCms: true },
  blog_detail_bottom_cta: { supportsCms: true },
  widget: { supportsCms: true, supportsAdvanced: true },
};

for (const nodeType of BLOG_SECTION_NODE_TYPES) {
  OVERRIDES_BASE[nodeType] = { supportsCms: true };
}
