...
export function sanitizeInlineMarginCss(css) {
  ...
  const hasShorthand = css.margin != null && css.margin !== '';
  const hasLonghand =
    (css.marginTop != null && css.marginTop !== '') ||
    (css.marginRight != null && css.marginRight !== '') ||
    (css.marginBottom != null && css.marginBottom !== '') ||
    (css.marginLeft != null && css.marginLeft !== '');
  if (!hasShorthand) return css;
  const out = { ...css };
  if (hasLonghand) {
    delete out.margin;
    return out;
