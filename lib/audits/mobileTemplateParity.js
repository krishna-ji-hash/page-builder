...
export const MOBILE_PARITY_TEMPLATE_GROUPS = {
  ...
  features: ['features', 'featureTabs', 'whyChooseCourier', 'courierFeatureBands', 'courierPartners', 'integrationBenefits', 'integrationSteps', 'integrationFeatures', 'aiCourierRecommendation', 'businessTypes', 'benefits'],
  cards: ['cards'],
  pricing: ['pricing'],
  faq: ['faq'],
  faqFullPage: ['faqFullPage'],
  blogFullPage: ['blogFullPage', 'blogHubHero', 'blogCategoryTabs', 'blogFeaturedArticle', 'blogArticlesGrid', 'blogGuidesSection', 'blogNewsletterSection', 'blogFinalCta'],
