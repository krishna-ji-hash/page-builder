...
function parseHeadingFontWeight(raw, fallback = 800) {
...
export function normalizeSectionHeading(raw) {
  ...
  return {
    ...
    fontWeight: parseHeadingFontWeight(s.fontWeight, 800),
  };
}
...
export function normalizeColumnHeading(raw) {
  ...
  return {
    ...
    fontWeight: parseHeadingFontWeight(c.fontWeight, 800),
  };
}
...
export function sectionHeadingToStyleVars(sh) {
  ...
  return {
    ...
    '--bld-section-title-font-weight': s.fontWeight,
  };
}
...
export function columnHeadingToStyleVars(ch) {
  ...
  return {
    ...
    '--bld-column-title-font-weight': c.fontWeight,
  };
}
...
export function sectionHeadingInspectorFields(props, pick) {
  ...
  return {
    ...
    sectionHeadingFontWeight: p('sectionHeadingFontWeight', s.fontWeight),
  };
}
...
export function columnHeadingInspectorFields(props, pick) {
  ...
  return {
    ...
    columnHeadingFontWeight: p('columnHeadingFontWeight', c.fontWeight),
  };
}
...
export function patchSectionHeadingFromKey(key, value, prev) {
  ...
  } else if (key === 'sectionHeadingFontWeight') {
    next.fontWeight = parseHeadingFontWeight(value, 800);
  } else return null;
...
export function patchColumnHeadingFromKey(key, value, prev) {
  ...
  } else if (key === 'columnHeadingFontWeight') {
    next.fontWeight = parseHeadingFontWeight(value, 800);
  } else return null;
