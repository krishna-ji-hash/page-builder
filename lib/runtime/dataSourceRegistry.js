...
export const dataSourceRegistry = {
  ...
  products: {
    ...
    defaultFields: [],
    id: 'products',
    path: '/api/runtime/data/products',
    allowedMethods: ['GET'],
    columns: [
      { key: 'id', label: 'ID' },
      { key: 'sku', label: 'SKU' },
  ...
  'related-products': {
    ...
    endpoint: {
      GET: '/api/runtime/data/related-products',
    },
    defaultColumns: [
      { key: 'id', label: 'ID' },
      { key: 'sku', label: 'SKU' },
    ...
    defaultFields: [],
    id: 'related-products',
    path: '/api/runtime/data/related-products',
    allowedMethods: ['GET'],
    columns: [
      { key: 'id', label: 'ID' },
      { key: 'sku', label: 'SKU' },
  ...
  categories: {
    ...
    label: 'Categories',
    endpoint: {
      GET: '/api/runtime/data/categories',
    },
    defaultColumns: [
      { key: 'id', label: 'ID' },
      { key: 'slug', label: 'Slug' },
    ...
    defaultFields: [],
    id: 'categories',
    path: '/api/runtime/data/categories',
    allowedMethods: ['GET'],
    columns: [
      { key: 'id', label: 'ID' },
      { key: 'slug', label: 'Slug' },
