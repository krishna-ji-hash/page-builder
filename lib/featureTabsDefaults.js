/** Default panels for Shipmozo-style feature tabs (section template + tabs widget). */
...
export const DEFAULT_FEATURE_TABS = [
  ...
  },
  {
    ...
    paragraph:
      "Shipmozo's AI courier selection engine auto-assigns the best courier for every shipment based on lane performance, delivery speed, COD risk, pincode serviceability, and shipping cost — so you get higher delivery success rates with fewer NDR exceptions and lower RTO.",
    bullets: [
