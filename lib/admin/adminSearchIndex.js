...
export function buildAdminSearchIndex({ projects = [], pages = [], activeProject = null } = {}) {
  ...
  for (const project of projects) {
    ...
    entries.push({
      ...
      label: name,
      category: 'Project',
      href: adminProjectSectionPath(project, 'overview', pathOpts),
    ...
    for (const section of PROJECT_SECTIONS) {
      entries.push({
        ...
        category: 'Workspace',
        href: adminProjectSectionPath(project, section.id, pathOpts),
  ...
  for (const page of pages) {
    ...
    entries.push({
      ...
      label: title,
      category: 'Page',
      href: adminBuilderPagePath(projectSlug, page.slug, pathOpts),
    ...
    if (page.projectId) {
      entries.push({
        ...
        category: 'Page',
        href: adminProjectSectionPath(page.projectSlug || page.projectId, 'pages', pathOpts),
