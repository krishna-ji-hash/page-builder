          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  style_json: rowStyle({
                    layout: { gap: 12, justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap' },
                  }),
                  children: [1, 2, 3, 4].map((n) => ({
                    nodeType: 'column',
                    displayName: `Logo ${n}`,
                    style_json: columnStyle({ size: { width: '25%' } }),
                    children: [
                      {
                        nodeType: 'stack',
                        displayName: `Logo ${n} stack`,
                        style_json: desktop({
                          layout: { alignItems: 'center', justifyContent: 'center', width: '100%' },
          ...
          children: [
            {
              ...
              children: [
                ...
                },
                {
                  ...
                  style_json: rowStyle({ layout: { gap: 14, justifyContent: 'space-between', alignItems: 'stretch' } }),
                  children: [
                ...
                children: [
                  {
                    ...
                    style_json: desktop({
                      layout: { flexDirection: 'column', gap: 8 },
                      spacing: { padding: '16px' },
                      border: { width: '1px', color: 'rgba(15,23,42,0.10)', radius: '18px' },
                      background: { backgroundColor: '#f8fafc' },
                    }),
