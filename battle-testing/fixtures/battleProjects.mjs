...
export const BATTLE_PROJECTS = [
  ...
  },
  {
    ...
    cmsCollections: [
      {
        ...
        schema: {
          fields: [
            { id: 'price', label: 'Price', type: 'number' },
            { id: 'salePrice', label: 'Sale price', type: 'number' },
            { id: 'sku', label: 'SKU', type: 'text' },
            { id: 'category', label: 'Category', type: 'text' },
            { id: 'featured', label: 'Featured', type: 'boolean' },
            { id: 'image', label: 'Image', type: 'image' },
            { id: 'gallery', label: 'Gallery', type: 'json' },
            { id: 'stock', label: 'Stock', type: 'number' },
            { id: 'description', label: 'Description', type: 'text' },
            { id: 'tags', label: 'Tags', type: 'json' },
            { id: 'variants', label: 'Variants', type: 'json' },
          ],
        },
      },
      {
      ...
      },
      {
        ...
        schema: {
          fields: [
            { id: 'productSlug', label: 'Product slug', type: 'text' },
            { id: 'sku', label: 'SKU', type: 'text' },
    ...
    cmsItems: [
      {
        collectionSlug: 'product_categories',
        slug: 'lighting',
        title: 'Lighting',
        status: 'published',
        data: { image: IMG.shop, description: 'Desk lamps, ambient lights, and more.', parent: '', sortOrder: 1 },
      },
      {
        collectionSlug: 'product_categories',
        slug: 'audio',
        title: 'Audio',
        status: 'published',
        data: { image: IMG.hero, description: 'Headphones and speakers.', parent: '', sortOrder: 2 },
      },
      {
        ...
        data: {
          ...
          featured: true,
          image: IMG.shop,
          gallery: [IMG.shop, IMG.hero],
          stock: 14,
          description: 'A focused desk lamp with warm light and premium build.',
          tags: ['featured', 'home'],
          variants: [{ sku: 'SKU-LAMP-001-BLK', title: 'Black', options: { color: 'Black' }, price: 79, stock: 8 }],
        },
      },
      {
        collectionSlug: 'products',
        ...
        data: {
          ...
          featured: false,
          image: IMG.hero,
          gallery: [IMG.hero, IMG.shop],
          stock: 22,
          description: 'Over-ear headphones with active noise cancellation.',
          tags: ['audio'],
          variants: [{ sku: 'SKU-AUD-010-S', title: 'Standard', options: {}, price: 249, stock: 22 }],
        },
      },
      {
        collectionSlug: 'product_reviews',
        slug: 'desk-lamp-review-1',
        title: 'Great light',
        status: 'published',
        data: { productSlug: 'desk-lamp', sku: 'SKU-LAMP-001', rating: 5, author: 'Amit', text: 'Perfect for my desk.', status: 'approved' },
      },
      {
        collectionSlug: 'product_reviews',
        slug: 'desk-lamp-review-2',
        title: 'Pending review',
        status: 'published',
        data: { productSlug: 'desk-lamp', sku: 'SKU-LAMP-001', rating: 3, author: 'Priya', text: 'Okay.', status: 'pending' },
      },
      {
        collectionSlug: 'faqs',
        slug: 'shipping-time',
        title: 'Shipping time',
        status: 'published',
        data: { question: 'How long does shipping take?', answer: 'Usually 2–5 business days.', category: 'shipping', sortOrder: 1 },
      },
    ],
    pages: [
      {
      ...
      },
      {
        ...
        sections: [
          stackSection('Product hero', [
            { nodeType: 'pdp_breadcrumbs', displayName: 'Breadcrumbs', props: { style_json: {} }, children: [] },
            heading({ text: '{{item.title}}', tag: 'h1' }),
            { nodeType: 'pdp_sale_badge', displayName: 'Sale badge', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_gallery', displayName: 'Gallery', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_variant_selector', displayName: 'Variant selector', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_price', displayName: 'Price', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_stock', displayName: 'Stock', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_quantity', displayName: 'Quantity', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_add_to_cart', displayName: 'Add to cart', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_delivery_eta', displayName: 'Delivery ETA', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_description', displayName: 'Description', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_specifications', displayName: 'Specifications', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_reviews', displayName: 'Reviews', props: { style_json: {} }, children: [] },
            { nodeType: 'pdp_related', displayName: 'Related', props: { style_json: {} }, children: [] },
          ]),
        ],
      },
      seoLandingPage({
