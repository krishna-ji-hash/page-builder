...
export const PARITY_INLINE_STYLE_CONTRACTS = Object.freeze({
  ...
  tabHeroPanelImage: {
    module: 'lib/tabHeroPanelImage.js',
    markerAttr: 'data-th-panel-image',
    appliesTo: 'Tab hero background image (all panels)',
  },
});
...
export const PARITY_BUILDER_CHROME_ALLOW = Object.freeze([
  ...
  '.live-tab-hero__builder-hint',
  '.live-tab-hero__editable:focus',
  '.live-tab-hero__image-btn',
]);
