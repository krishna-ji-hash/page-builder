...
const BLOCKED_CLICK_SELECTOR = [
  ...
  '.live-faq-full-page__tab',
  '.live-faq-full-page__add-btn',
  '.live-faq-full-page__accordion-toggle',
  '.live-faq-full-page__editable',
  '.live-faq-full-page__cta-feature-label',
  '.live-faq-full-page__cta-btn-text',
  '.live-faq-full-page__popular-chip',
  '.live-faq-full-page__empty-reset',
  '.live-blog-full-page__tab',
  '.live-blog-full-page__add-btn',
  '.live-blog-full-page__editable',
  '.live-blog-full-page__search-btn',
  '.live-blog-full-page__topic-chip',
  'input',
  'textarea',
  'select',
  'option',
...
export function shouldStartFeatureTabTextEdit(event) {
  ...
  if (
    target.closest(
      '.live-feature-tabs__tab, .live-feature-tabs__image-btn, .live-feature-tabs__figure--editable input[type="file"], .live-tab-hero__tab, .live-tab-hero__image-btn, .live-tab-hero__stage input[type="file"]'
    )
  ) {
    return false;
  }
  return Boolean(
    target.closest(FEATURE_TAB_FIELD_SELECTOR) ||
      target.closest('.bld-el-grid__title, .bld-el-grid__text, [data-grid-block]')
  );
}
