...
export const DEFAULT_SECTION_LAYOUTS = {
  ...
  faqFullPage: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogFullPage: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogDetailPage: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogDetailHero: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogDetailArticle: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogDetailSidebar: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogDetailBottomCta: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogHubHero: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogCategoryTabs: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogFeaturedArticle: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogArticlesGrid: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogGuidesSection: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogNewsletterSection: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
  blogFinalCta: { direction: 'vertical', columns: 1, gap: 'medium', align: 'stretch', mobileStack: true, reverse: false },
