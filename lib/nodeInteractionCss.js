...
export function hasNodeInteractions(style = {}) {
  ...
  if (ix.active && typeof ix.active === 'object' && Object.keys(ix.active).length) return true; // legacy
...
export function interactionInlineStyleVars(style = {}) {
  ...
  // Preferred: `pressed` (pointer down). Legacy: `active` (kept for old snapshots).
