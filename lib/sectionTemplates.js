  ...
  heroLanding: [
    {
      ...
      style_json: rowStyle({
        layout: { gap: 28, justifyContent: 'center', alignItems: 'stretch' },
        spacing: { padding: '84px 24px' },
        background: {
          backgroundColor: '#f3f6ff',
          backgroundImage:
            'radial-gradient(900px 520px at 18% 22%, rgba(59,130,246,0.16) 0%, transparent 55%), radial-gradient(820px 520px at 78% 30%, rgba(99,102,241,0.16) 0%, transparent 60%), linear-gradient(180deg, #f6f8ff 0%, #eef3ff 100%)',
          backgroundSize: 'cover',
        },
      }),
      children: [
        {
          ...
          style_json: columnStyle({ size: { width: '56%', maxWidth: '680px' } }),
          children: [
            {
              nodeType: 'stack',
              ...
              children: [
                {
                  nodeType: 'text',
                  displayName: 'Kicker',
                  props: { text: 'Premium Personal Portfolio Suite' },
                  style_json: desktop({
                    typography: { fontSize: '12px', fontWeight: '900', letterSpacing: '0.06em' },
                    colors: { textColor: '#1d4ed8' },
                    spacing: { padding: '8px 12px' },
                    border: { width: '1px', color: 'rgba(59,130,246,0.25)', radius: '999px' },
                    background: { backgroundColor: 'rgba(59,130,246,0.10)' },
                  }),
                },
                {
                  nodeType: 'heading',
                  displayName: 'Headline',
                  props: { text: 'CREATIVE PORTFOLIO & RESUME SYSTEM.' },
                  style_json: desktop({
                    typography: { fontSize: '60px', fontWeight: '950', lineHeight: '0.98', letterSpacing: '-0.03em' },
                    colors: { textColor: '#0b1220' },
                  }),
                },
                {
                  nodeType: 'text',
                  displayName: 'Subcopy',
                  props: {
                    text: 'A sophisticated collection of three high‑fidelity portfolio archetypes. Built for architects, engineers, and digital specialists who demand technical perfection.',
                  },
                  style_json: desktop({
                  ...
                  children: [
                    ...
                    },
                    {
                      ...
                      style_json: desktop({
                        ...
                        typography: { fontSize: '12px', fontWeight: '950', letterSpacing: '0.08em' },
                        colors: { textColor: '#0b1220', backgroundColor: 'rgba(255,255,255,0.70)' },
                ...
                },
                {
                  ...
                  children: [
                    ...
                    displayName: b.text,
                    style_json: desktop({
                      layout: { flexDirection: 'row', gap: 8, alignItems: 'center', flex: '0 1 auto' },
                      spacing: { padding: '10px 12px' },
                      border: { width: '1px', color: 'rgba(15,23,42,0.08)', radius: '999px' },
                    ...
                    children: [
                      {
                        ...
                        displayName: 'Icon',
                        props: { text: b.icon },
                        style_json: desktop({ typography: { fontSize: '12px', fontWeight: '900' }, colors: { textColor: '#2563eb' } }),
                      },
                      {
                        nodeType: 'text',
                        displayName: 'Label',
                        props: { text: b.text },
                        style_json: desktop({ typography: { fontSize: '12px', fontWeight: '800' }, colors: { textColor: '#0b1220' } }),
                      },
                    ],
                  })),
                },
        ...
        },
        {
          nodeType: 'column',
          displayName: 'Hero visual',
          style_json: columnStyle({ size: { width: '44%', maxWidth: '560px' } }),
          children: [
            {
              nodeType: 'stack',
              ...
              style_json: desktop({
                ...
                background: { backgroundColor: 'rgba(255,255,255,0.85)' },
              ...
              children: [
                {
                  ...
                  props: {
                    src: 'https://via.placeholder.com/1200x760?text=Portfolio+Preview',
              ...
              children: [
                ...
                },
                {
                  ...
                  children: [
                    ...
                    style_json: desktop({
                      layout: { flexDirection: 'column', gap: 10, alignItems: 'stretch', flex: '1 1 30%', minWidth: '240px', maxWidth: '100%' },
                      spacing: { padding: '16px' },
                ...
                },
                {
                  ...
                  children: [1, 2, 3, 4].map((n) => ({
                    ...
                    style_json: desktop({
                      ...
                      spacing: { padding: '10px 12px' },
                      border: { width: '1px', color: 'rgba(15,23,42,0.08)', radius: '14px' },
                      background: { backgroundColor: '#f8fafc' },
                    }),
                    children: [
                      {
                        ...
                        props: {
                          src: `https://via.placeholder.com/180x54?text=Logo+${n}`,
                          alt: `Client logo ${n}`,
                          imageFit: 'contain',
                          imageHeightPx: 26,
                        },
              ...
              children: [
                {
                  nodeType: 'image',
                  displayName: 'Dashboard preview',
                  props: { src: 'https://via.placeholder.com/1400x900?text=Dashboard+Preview', alt: 'Dashboard preview', imageFit: 'cover', imageHeightPx: 420 },
                  style_json: desktop({ border: { radius: '14px' } }),
                },
              ],
            },
          ],
          ...
          children: [
            {
              ...
              children: [
                ...
                nodeType: 'stack',
                displayName: `Stat ${idx + 1}`,
                style_json: desktop({
                  layout: { flexDirection: 'column', gap: 6, flex: '1 1 30%', minWidth: '200px', maxWidth: '100%' },
                  spacing: { padding: '16px' },
                  border: { width: '1px', color: 'rgba(15,23,42,0.10)', radius: '18px' },
                  background: { backgroundColor: '#f8fafc' },
                }),
                children: [
                  { nodeType: 'heading', displayName: 'Value', props: { text: s.v }, style_json: desktop({ typography: { fontSize: '22px', fontWeight: '950' }, colors: { textColor: '#0f172a' } }) },
                  { nodeType: 'text', displayName: 'Label', props: { text: s.l }, style_json: desktop({ typography: { fontSize: '13px', fontWeight: '750' }, colors: { textColor: '#64748b' } }) },
                ],
              })),
            },
          ],
          ...
          children: [
            {
              ...
              children: [
                ...
                { nodeType: 'button', displayName: 'Start free', props: { text: 'Start Free', href: '#' }, style_json: desktop({ spacing: { padding: '14px 24px' }, typography: { fontSize: '14px', fontWeight: '950' }, colors: { textColor: '#0b1220', backgroundColor: '#ffffff' }, border: { radius: '999px' } }) },
